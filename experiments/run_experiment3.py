"""Experiment 3: Mixed stream vs ground truth."""
...
DATA_MIXED = ROOT / "data" / "mixed_stream.json"
DATA_GT = ROOT / "data" / "mixed_stream_ground_truth.json"
...
async def run(recorder: Recorder | None = None) -> dict[str, Any]:
    ...
    async for stream_index, rec in stream_file(DATA_MIXED, interval_seconds=0.0):
